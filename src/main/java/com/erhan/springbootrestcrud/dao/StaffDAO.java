...
public interface StaffDAO extends JpaRepository<Staff, Long>{
	...
	public List<Staff> findByDepartment_Id(Long id, Pageable pageable);
	...
	public List<Staff> findByFirstNameAndDepartment_Id(String firstName, Long departmentId, Pageable pageable);
	public List<Staff> findByLastNameAndDepartment_Id(String lastName, Long departmentId);
	public List<Staff> findByLastNameAndDepartment_Id(String lastName, Long departmentId, Pageable pageable);
